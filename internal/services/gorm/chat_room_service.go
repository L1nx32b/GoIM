...
import "GoChatServer/internal/dto/respond"
...
func (c *chatRoomService) GetCurContactListInChatRoom(ownerId, contactId string) (string, []respond.GetCurContactListInChatRoomRespond, int) {
