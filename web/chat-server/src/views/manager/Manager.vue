...
.header-container {
  ...
  border-top-right-radius: 8px; /* 像素风格小圆角 */
...
.el-menu {
  ...
  border: 1px solid #8B7355; /* 细棕色边框 */
  image-rendering: pixelated;
  padding: 0 !important; /* 清除默认内边距 */
  margin: 0 0 8px 0; /* 仅保留上下间距，无左右边距 */
...
.el-menu-item {
  ...
  color: #333333;
  padding-left: 12px !important; /* 强制缩进，不影响宽度 */
  margin: 0 !important; /* 清除默认外边距 */
  width: 100% !important; /* 强制占满menu宽度 */
  box-sizing: border-box;
  image-rendering: pixelated;
}
...
.manager-aside-container {
  width: 200px;
  border-right: 2px solid #8B7355; /* 像素边框 */
  display: flex;
  flex-direction: column;
  border-bottom-left-radius: 8px; /* 像素风格小圆角 */
  background-color: #FFFEF0; /* 浅米黄色 */
  image-rendering: pixelated;
}
